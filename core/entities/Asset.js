...
function Asset(assetOrSymbol) {
    ...
    if (isAsset(assetOrSymbol)) {
        const asset = assetOrSymbol;
        assetMap.set(assetOrSymbol.symbol.toLowerCase(), Object.assign(Object.assign({}, asset), { displaySymbol: asset.displaySymbol || asset.symbol }));
