...
export declare enum PoolState {
    ...
    INSUFFICIENT_FUNDS_FROM = 6,
    INSUFFICIENT_FUNDS_TO = 7
}
export declare function useReactivePoolCalculator(input: {
    ...
    state: import("@vue/reactivity").ComputedRef<PoolState.SELECT_TOKENS | PoolState.ZERO_AMOUNTS | PoolState.INSUFFICIENT_FUNDS | PoolState.VALID_INPUT | PoolState.ZERO_AMOUNTS_NEW_POOL | PoolState.INSUFFICIENT_FUNDS_FROM | PoolState.INSUFFICIENT_FUNDS_TO>;
