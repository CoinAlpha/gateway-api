...
exports.useReactivePoolCalculator = exports.PoolState = void 0;
...
(function (PoolState) {
    ...
    PoolState[PoolState["INSUFFICIENT_FUNDS_FROM"] = 6] = "INSUFFICIENT_FUNDS_FROM";
    PoolState[PoolState["INSUFFICIENT_FUNDS_TO"] = 7] = "INSUFFICIENT_FUNDS_TO";
})(PoolState = exports.PoolState || (exports.PoolState = {}));
function useReactivePoolCalculator(input) {
    ...
    const fromBalanceOverdrawn = reactivity_1.computed(() => {
        var _a;
        return (_a = tokenABalance.value) === null || _a === void 0 ? void 0 : _a.lessThan(tokenAField.fieldAmount.value || "0");
    });
    const toBalanceOverdrawn = reactivity_1.computed(() => {
        var _a;
        return (_a = tokenBBalance.value) === null || _a === void 0 ? void 0 : _a.lessThan(tokenBField.fieldAmount.value || "0");
    });
...
exports.useReactivePoolCalculator = useReactivePoolCalculator;
//# sourceMappingURL=reactiveAddLiquidityCalculator.js.map