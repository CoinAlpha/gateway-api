...
function parseAsset(a) {
    return entities_1.Asset(Object.assign(Object.assign({}, a), { displaySymbol: a.displaySymbol || a.symbol, label: parseLabel(a) }));
}
function parseAssets(configAssets) {
    return configAssets.map(parseAsset);
}
exports.parseAssets = parseAssets;
function parseConfig(config, assets, chainConfigsByNetwork, peggyCompatibleCosmosBaseDenoms, createCosmosWalletProvider) {
    var _a;
