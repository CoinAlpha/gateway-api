...
export function HeightAtWhichTheProofWasGeneratedFromJSON(
  json: any,
): HeightAtWhichTheProofWasGenerated {
  return HeightAtWhichTheProofWasGeneratedFromJSONTyped(json, false);
}

export function HeightAtWhichTheProofWasGeneratedFromJSONTyped(
  json: any,
...
export function HeightAtWhichTheProofWasGeneratedToJSON(
  value?: HeightAtWhichTheProofWasGenerated | null,
): any {
  if (value === undefined) {
    return undefined;
  }
