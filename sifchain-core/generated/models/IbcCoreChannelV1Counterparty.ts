...
export function IbcCoreChannelV1CounterpartyFromJSON(
  json: any,
): IbcCoreChannelV1Counterparty {
  return IbcCoreChannelV1CounterpartyFromJSONTyped(json, false);
}

export function IbcCoreChannelV1CounterpartyFromJSONTyped(
  json: any,
...
export function IbcCoreChannelV1CounterpartyToJSON(
  value?: IbcCoreChannelV1Counterparty | null,
): any {
  if (value === undefined) {
    return undefined;
  }
