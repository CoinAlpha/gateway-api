...
const ethGasStationEnabled = globalConfig.getConfig("ENABLE_ETH_GAS_STATION") || false
...
export default class Fees {
  constructor () {
    this.ethGasStationGasLevel = globalConfig.getConfig("ETH_GAS_STATION_GAS_LEVEL")
    this.ethGasStationRefreshTime = (globalConfig.getConfig("ETH_GAS_STATION_REFRESH_TIME") || defaultRefreshInterval) * 1000
